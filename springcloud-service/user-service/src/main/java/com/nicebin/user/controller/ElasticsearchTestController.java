 ...
 */
@RestController
@RequestMapping("/elasticsearchTest")
public class ElasticsearchTestController {
    ...
    public ResultJson doInsert(@RequestBody User user, @RequestHeader(value = "index") String index, @RequestHeader(value = "id", required = false) String id) throws IOException {
        ...
        if (shardInfo.getFailed() > 0) {
            ...
            message.append("创建失败 ");
            return new ResultJson("200", message.toString(), reason);
        } else {
            message.append("集群部分创建成功 ");
        }
        return new ResultJson("200", message.toString());
    }

    @RequestMapping("/doUpdate")
    public ResultJson doUpdate(@RequestBody User user, @RequestHeader(value = "index") String index, @RequestHeader(value = "id") String id) throws IOException {
        ...
        if (updateResponse.getResult() == DocWriteResponse.Result.CREATED) {
            ...
            return new ResultJson("更新失败");
        }
    }

    @RequestMapping("/doDelete")
    public ResultJson doDelete(@RequestBody User user, @RequestHeader(value = "index") String index, @RequestHeader(value = "id") String id) throws IOException {
        ...
        if (deleteResponse.getResult() == DocWriteResponse.Result.DELETED) {
            ...
            return new ResultJson("删除失败 执行序列号：" + deleteResponse.getSeqNo());
        }
    }
    ...
    public ResultJson getByMatch(@RequestBody JSONObject params, @RequestHeader(value = "index", required = false) String index) throws IOException {
    ...
    public ResultJson getByTerm(@RequestBody JSONObject params, @RequestHeader(value = "index", required = false) String index) throws IOException {
        //1、创建搜索请求对象SearchRequest，设置查询的指定索引
        SearchRequest searchRequest;
        if(index == null){
            searchRequest = new SearchRequest();
