package com.springclouddemo.redis.task;

import com.springclouddemo.redis.cache.CacheInvocation;
...
/**
 * @author NiceBin
 * @description: 刷新缓存某个缓存的任务
 * @date 2019/11/29 15:29
 */
public class UpdateCacheTask implements Callable<Boolean> {
    //将要执行的方法信息
     ...
     * @param id
     */
    public UpdateCacheTask(CacheInvocation cacheInvocation, Cache cache, Object id){
    ...
    public Boolean call() throws Exception{
        if(cacheInvocation == null){
            throw new RuntimeException("更新缓存线程时，方法信息不能为null");
        }
