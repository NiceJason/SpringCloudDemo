package com.springclouddemo.redis.aop;

import com.nicebin.common.utils.Tool;
import com.springclouddemo.redis.cache.RedisCacheEnhance;
import com.springclouddemo.redis.cache.SystemCacheMgr;
...
public class CacheAspect {
     ...
     * @param joinPoint
     */
    @Before(value = "@annotation(com.springclouddemo.redis.annotation.UpdateCache)&&args(id)")
